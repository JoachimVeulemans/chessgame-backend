...
namespace ChessBackend.Migrations
{
    ...
    [Migration("20190914183229_user bio")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChessBackend.Data.DataEntities.FamousGame", b =>
                {
            ...
            modelBuilder.Entity("ChessBackend.Data.DataEntities.Game", b =>
                {
            ...
            modelBuilder.Entity("ChessBackend.Data.DataEntities.User", b =>
                {
            ...
            modelBuilder.Entity("ChessBackend.Data.DataEntities.Game", b =>
                {
                    b.HasOne("ChessBackend.Data.DataEntities.User", "BlackPlayer")
                        .WithMany("GamesAsBlack")
                        .HasForeignKey("BlackPlayerId");

                    b.HasOne("ChessBackend.Data.DataEntities.User", "WhitePlayer")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ChessBackend.Data.DataEntities.User")
                        .WithMany()
