...
namespace ChessBackend.Migrations
{
    ...
    [Migration("20190904225947_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChessBackend.Entities.FamousGame", b =>
                {
            ...
            modelBuilder.Entity("ChessBackend.Entities.Game", b =>
                {
            ...
            modelBuilder.Entity("ChessBackend.Entities.Game", b =>
                {
                    b.HasOne("ChessBackend.Entities.User", "BlackPlayer")
                        .WithMany("GamesAsBlack")
                        .HasForeignKey("BlackPlayerId");

                    b.HasOne("ChessBackend.Entities.User", "WhitePlayer")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ChessBackend.Entities.User")
                        .WithMany()
